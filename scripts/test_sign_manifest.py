#!/usr/bin/env python3
"""`sign-manifest.py` — the `den.dataset.v2` payload, and signatures openssl agrees with."""
import base64
...
_spec = importlib.util.spec_from_file_location("sign_manifest", os.path.join(HERE, "sign-manifest.py"))
