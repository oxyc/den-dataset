"""`build_worklist.py` — where it looks for the shipped labels, and how it fetches TMDB's daily dumps.
...
def load(out_dir, labels=None):
    ...
    with mock.patch.dict(os.environ, env):
        ...
        spec = importlib.util.spec_from_file_location("build_worklist", os.path.join(HERE, "build_worklist.py"))
