...
#: facts; and publishing is last because it uploads what the store wrote. That ordering is the whole reason
#: a stage can stop naming a producer for an artifact another stage makes.
#:
